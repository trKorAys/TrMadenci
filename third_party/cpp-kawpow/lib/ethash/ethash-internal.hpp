...
extern "C" struct ethash_epoch_context_full : ethash_epoch_context
{
    ...
    constexpr ethash_epoch_context_full(int epoch, int light_num_items,
        const ethash_hash512* light, const uint32_t* l1, int dataset_num_items, int dataset_parents,
        ethash_hash1024* dataset) noexcept
      : ethash_epoch_context{epoch, light_num_items, light, l1, dataset_num_items, dataset_parents},
