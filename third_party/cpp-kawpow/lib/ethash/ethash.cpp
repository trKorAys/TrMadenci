...
{
    return create_epoch_context_configured(
        build_fn, epoch_number, epoch_number, full_dataset_item_parents, full);
}

epoch_context_full* create_epoch_context_configured(build_light_cache_fn build_fn,
    int dataset_epoch_number, int seed_epoch_number, int dataset_item_parents, bool full) noexcept
{
    ...
    const int light_cache_num_items = calculate_light_cache_num_items(dataset_epoch_number);
    const int full_dataset_num_items = calculate_full_dataset_num_items(dataset_epoch_number);
    ...
    const hash256 epoch_seed = calculate_epoch_seed(seed_epoch_number);
...
epoch_context* ethash_create_epoch_context_configured(
    int dataset_epoch_number, int seed_epoch_number, int dataset_item_parents) noexcept
{
    if (dataset_epoch_number < 0 || seed_epoch_number < 0 || dataset_item_parents <= 0)
        return nullptr;
    return generic::create_epoch_context_configured(build_light_cache, dataset_epoch_number,
        seed_epoch_number, dataset_item_parents, false);
}
